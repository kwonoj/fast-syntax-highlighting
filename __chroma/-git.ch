...
fsh__git__chroma__def=(
    ...
    NULL_0_opt "(-C|--exec-path=|--git-dir=|--work-tree=|--namespace=|--super-prefix=)
                   <<>> NO-OP // ::__chroma/main-chroma-std-aopt-action
                   <<>> NO-OP // ::__chroma/main-chroma-std-aopt-ARG-action
            || -c
    ...
    "subcommands" "::__chroma/-git-get-subcommands" # run a function (the :: causes this) and use `reply'
    #"subcommands" "(fetch|pull)" # run a function (the :: causes this) and use `reply'

    "subcmd-hook" "__chroma/-git-check-if-alias"
    ...
    REMOTE_GR_1_arg "NO-OP // ::__chroma/-git-verify-remote-or-group" # This definition is generic, reused later
    "REF_#_arg" "NO-OP // ::__chroma/-git-verify-ref" # This too
    "REMOTE_GR_#_arg" "NO-OP // ::__chroma/-git-verify-remote-or-group" # and this too
    ...
    REMOTE_1_arg "NO-OP // ::__chroma/-git-verify-remote" # This definition is generic, reused later
    ...
    "COMMIT_#_opt" "
              (-m|--message=|-am)
                       <<>> NO-OP // ::__chroma/-git-commit-msg-opt-action
                       <<>> NO-OP // ::__chroma/-git-commit-msg-opt-ARG-action
    ...
    # A generic action
    "FILE_#_arg" "NO-OP // ::__chroma/-git-verify-file"
    ...
    MERGE_0_opt
         ...
         || (--help|--commit|--no-commit|-e|--edit|--no-edit|--ff|--no-ff|--ff-only|
             ...
             --abort|--continue)
                       <<>> NO-OP // ::__chroma/main-chroma-std-aopt-action"
    COMMIT_\#_arg "NO-OP // ::__chroma/-git-verify-commit"
    ...
    RESET_1_arg "NO-OP // ::__chroma/-git-verify-commit"

    "RESET_#_arg" "NO-OP // ::__chroma/-git-RESET-verify-commit-or-file"
    ...
    "REVERT_#_arg" "NO-OP // ::__chroma/-git-verify-commit"
    ...
    # A generic action
    "COMMIT_FILE_DIR_#_arg" "NO-OP // ::__chroma/-git-verify-commit-or-file-or-dir"

    # A generic action
    "FILE_1_arg" "NO-OP // ::__chroma/-git-verify-file"

    # A generic action
    "FILE_2_arg" "NO-OP // ::__chroma/-git-verify-file"
    ...
    FILE_OR_DIR_#_arg "NO-OP // ::__chroma/-git-verify-file-or-dir"
    ...
    NEW_BRANCH_1_arg "NO-OP // ::__chroma/-git-verify-correct-branch-name"

    COMMIT_2_arg "NO-OP // ::__chroma/-git-verify-commit"
    ...
    # A generic action
    COMMIT_1_arg "NO-OP // ::__chroma/-git-verify-commit"

    # Unused
    FILE_OR_BRANCH_OR_COMMIT_1_arg "NO-OP // ::__chroma/-git-file-or-ubranch-or-commit-verify"
    FILE_OR_DIR_OR_BRANCH_OR_COMMIT_1_arg "NO-OP // ::__chroma/-git-file-or-dir-or-ubranch-or-commit-verify"
    ...
    REMOTE_A_NAME_2_arg "NO-OP // ::__chroma/-git-verify-correct-branch-name"
    REMOTE_A_NAME_3_arg "NO-OP // ::__chroma/-git-verify-correct-branch-name"
    REMOTE_A_URL_3_arg "NO-OP // ::__chroma/main-chroma-std-verify-url"
    REMOTE_A_URL_4_arg "NO-OP // ::__chroma/main-chroma-std-verify-url"
    BRANCH_3_arg "NO-OP // ::__chroma/-git-verify-branch"
    BRANCH_\#_arg "NO-OP // ::__chroma/-git-verify-branch"
    REMOTE_2_arg "NO-OP // ::__chroma/-git-verify-remote"
    REMOTE_\#_arg "NO-OP // ::__chroma/-git-verify-remote"
    ...
    LOG_1_arg "NO-OP // ::__chroma/-git-verify-rev-range-or-file"
    ...
    "TAG_0_opt^" "
             ...
             || (-F|--file)
                            <<>> NO-OP // ::__chroma/main-chroma-std-aopt-action
                            <<>> NO-OP // ::__chroma/-git-verify-file
    ...
    TAG_NEW_1_arg "NO-OP // ::__chroma/-git-verify-correct-branch-name"

    TAG_1_arg "NO-OP // ::__chroma/-git-verify-tag-name"
    ...
    "TAG_#_arg" "NO-OP // ::__chroma/-git-verify-tag-name"
    ...
    "TAG_PAT_#_arg" "NO-OP // ::__chroma/main-chroma-std-verify-pattern"
    ...
    "CATCH_ALL_#_opt" "* <<>> NO-OP // ::__chroma/main-chroma-std-aopt-SEMI-action"

    ## }}}
)

# Called after entering just "git" on the command line
__chroma/-git-first-call() {
...
__chroma/-git-check-if-alias() {
    local _wrd="$1"
    local -a _result

    typeset -ga fsh__chroma__git__aliases
    _result=( ${(M)fsh__chroma__git__aliases[@]:#${_wrd}[[:space:]]##*} )
    __chroma/main-chroma-print "Got is-alias-_result: $_result"
    [[ -n "$_result" ]] && \
...
__chroma/-git-verify-remote-or-group() {
    __chroma/-git-verify-remote "$@" && return 0
...
# A generic handler - checks whether the file exists
__chroma/-git-verify-file-or-dir() {
...
__chroma/-git-verify-also-unfetched-ref() {
    local _wrd="$4"
...
# A generic handler
__chroma/-git-file-or-ubranch-or-commit-verify() {
    __chroma/-git-verify-commit "$@" && return
    __chroma/-git-verify-file "$@" && return
    __chroma/-git-verify-also-unfetched-ref "$@"
}

# A generic handler
__chroma/-git-file-or-dir-or-ubranch-or-commit-verify() {
    __chroma/-git-verify-commit "$@" && return
    __chroma/-git-verify-file-or-dir "$@" && return
    __chroma/-git-verify-also-unfetched-ref "$@"
}

# A generic handler
__chroma/-git-verify-correct-branch-name() {
    local _wrd="$4"
    __chroma/-git-verify-commit "$@" && \
...
__chroma/-git-verify-commit-or-file() {
    __chroma/-git-verify-commit "$@" && return
    __chroma/-git-verify-file "$@"
}
...
__chroma/-git-verify-commit-or-file-or-dir() {
    __chroma/-git-verify-commit "$@" && return
    __chroma/-git-verify-file-or-dir "$@"
}
...
__chroma/-git-verify-rev-range-or-file() {
    local _wrd="$4"

    __chroma/-git-verify-commit "$@" && return 0

    if [[ "$_wrd" = *..* ]]; then
        (( FAST_HIGHLIGHT[chroma-git-reset-etc-saw-file] )) && {
            __chroma/-git-verify-file "$@" && return 0
...
# does the same what __chroma/main-chroma-std-aopt-action does
__chroma/-git-commit-msg-opt-action() {
    __chroma/main-chroma-std-aopt-action "$@"
}

# A handler for the commit's -m/--message options' argument
__chroma/-git-commit-msg-opt-ARG-action() {
    integer _start="$2" _end="$3"
    local _scmd="$1" _wrd="$4"
...
__chroma/-git-RESET-verify-commit-or-file() {
    __chroma/-git-verify-commit "$@" && {
        __chroma/-git-verify-file "$@" && {
