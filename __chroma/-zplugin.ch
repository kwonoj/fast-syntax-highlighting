...
fsh__zplugin__chroma__def=(
    ...
    "ICE_#_arg" "NO-OP // ::__chroma/-zplugin-check-ice-mod"
    ...
    SNIPPET_1_arg "NO-OP // ::__chroma/-zplugin-verify-snippet"
    ...
    LOAD_1_arg "NO-OP // ::__chroma/-zplugin-verify-plugin"

    LOAD_2_arg "NO-OP // ::__chroma/-zplugin-verify-plugin"
    ...
    UNLOAD_1_arg "NO-OP // ::__chroma/-zplugin-verify-loaded-plugin"

    UNLOAD_2_arg "NO-OP // ::__chroma/-zplugin-verify-loaded-plugin"
    ...
    COMPLETION_1_arg "NO-OP // ::__chroma/-zplugin-verify-disabled-completion"
    ...
    DISCOMPLETION_1_arg "NO-OP // ::__chroma/-zplugin-verify-completion"
    ...
    UNCOMPILE_1_arg "NO-OP // ::__chroma/-zplugin-verify-compiled-plugin"
...
__chroma/-zplugin-verify-loaded-plugin() {
    local _scmd="$1" _wrd="$4"
...
__chroma/-zplugin-verify-completion() {
    local _scmd="$1" _wrd="$4"
...
__chroma/-zplugin-verify-disabled-completion() {
    local _scmd="$1" _wrd="$4"
    # Find enabled completions
    typeset -a completions
    completions=( "${ZPLGM[COMPLETIONS_DIR]}"/[^_]*(N:t) )
...
__chroma/-zplugin-verify-compiled-plugin() {
    local _scmd="$1" _wrd="$4"
...
__chroma/-zplugin-verify-snippet() {
...
__chroma/-zplugin-check-ice-mod() {
    local _scmd="$1" _wrd="$4"
    [[ "$_wrd" = (svn(\'|\")*|svn) ]] && \
